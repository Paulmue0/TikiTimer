...
public class HelperSharedPreferences {
    ...
    public static class SharedPreferencesKeys{
        public static final String shuffledTime="shuffledTime";
        public static final String tikiTimeInMillis="tikiTimeInMillis";
        public static final String shouldStop ="shouldStop";
    }
